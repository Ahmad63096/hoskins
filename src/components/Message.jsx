...
function Message() {
  ...
  const handleButtonClick = (buttonText) => {
    ...
    const buttonResponses = {
      "Audit & Assurance Services": "I want to know about Audit & Assurance Services.",
      "Advisory Services": "I want to know about Advisory Services.",
      "Tax Services": "I want to know about Tax Services.",
      "Investment & Financial Planning": "I want to know about Investment & Financial Planning.",
      "Employee Retention Credit (ERC) Assistance": "I want to know about Employee Retention Credit (ERC) Assistance."
    };
  ...
  useEffect(() => {
    const fetchGreetingMessage = async () => {
      try {
        ...
        const data = "Hey there! 🐼I’m your virtual assistant at Hoskins & Company. How are you today?😊";
